...
dependencies {
    testImplementation(project(":spotted-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../spotted-kotlin-core/src/main/resources/META-INF/proguard/spotted-kotlin-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../spotted-kotlin-core/src/main/resources/META-INF/proguard/spotted-kotlin-core.pro",
