...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    @Deprecated("deprecated") fun language(): String? = language.getNullable("language")
     ...
     *   server responded with an unexpected value).
     */
    fun restrictions(): EpisodeRestrictionObject? = restrictions.getNullable("restrictions")
