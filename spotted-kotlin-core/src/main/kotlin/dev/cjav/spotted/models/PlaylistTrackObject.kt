...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    @Deprecated("deprecated") fun track(): Track? = track.getNullable("track")
    ...
    private constructor(
         ...
         * import dev.cjav.spotted.core.JsonValue
         *
         * val result: String? = item.accept(object : Item.Visitor<String?> {
         *     override fun visitTrack(track: TrackObject): String? = track.toString()
         *
         *     // ...
         *
    ...
    private constructor(
         ...
         * import dev.cjav.spotted.core.JsonValue
         *
         * val result: String? = track.accept(object : Track.Visitor<String?> {
         *     override fun visitTrack(track: TrackObject): String? = track.toString()
         *
         *     // ...
         *
