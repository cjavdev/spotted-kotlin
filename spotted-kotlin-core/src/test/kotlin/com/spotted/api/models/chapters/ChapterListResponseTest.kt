...
internal class ChapterListResponseTest {

    @Test
    fun create() {
        val chapterListResponse =
            ChapterListResponse.builder()
                .addChapter(
                    ChapterListResponse.Chapter.builder()
                        ...
                        .releaseDatePrecision(ChapterListResponse.Chapter.ReleaseDatePrecision.DAY)
                        .type(ChapterListResponse.Chapter.Type.EPISODE)
        ...
        assertThat(chapterListResponse.chapters())
            .containsExactly(
                ChapterListResponse.Chapter.builder()
                    .id("5Xt5DXGzch68nYYamXrNxZ")
                    .audioPreviewUrl(
    ...
    fun roundtrip() {
        ...
        val roundtrippedChapterListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(chapterListResponse),
                jacksonTypeRef<ChapterListResponse>(),
            )

        assertThat(roundtrippedChapterListResponse).isEqualTo(chapterListResponse)
    }
}
