...
internal class ChapterBulkRetrieveResponseTest {

    @Test
    fun create() {
        val chapterBulkRetrieveResponse =
            ChapterBulkRetrieveResponse.builder()
                .addChapter(
                    ChapterBulkRetrieveResponse.Chapter.builder()
        ...
        assertThat(chapterBulkRetrieveResponse.chapters())
            .containsExactly(
                ChapterBulkRetrieveResponse.Chapter.builder()
                    .id("5Xt5DXGzch68nYYamXrNxZ")
                    .audioPreviewUrl(
    ...
    fun roundtrip() {
        ...
        val roundtrippedChapterBulkRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(chapterBulkRetrieveResponse),
                jacksonTypeRef<ChapterBulkRetrieveResponse>(),
            )

        assertThat(roundtrippedChapterBulkRetrieveResponse).isEqualTo(chapterBulkRetrieveResponse)
    }
}
