...
internal class AudiobookBulkRetrieveResponseTest {

    @Test
    fun create() {
        val audiobookBulkRetrieveResponse =
            AudiobookBulkRetrieveResponse.builder()
                .addAudiobook(
                    AudiobookBulkRetrieveResponse.Audiobook.builder()
                        .id("id")
                        ...
                        .edition("Unabridged")
                        .chapters(
                            AudiobookBulkRetrieveResponse.Audiobook.Chapters.builder()
        ...
        assertThat(audiobookBulkRetrieveResponse.audiobooks())
            .containsExactly(
                AudiobookBulkRetrieveResponse.Audiobook.builder()
                    .id("id")
                    .addAuthor(AuthorObject.builder().name("name").build())
    ...
    fun roundtrip() {
        ...
        val roundtrippedAudiobookBulkRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(audiobookBulkRetrieveResponse),
                jacksonTypeRef<AudiobookBulkRetrieveResponse>(),
            )

        assertThat(roundtrippedAudiobookBulkRetrieveResponse)
            .isEqualTo(audiobookBulkRetrieveResponse)
    }
}
