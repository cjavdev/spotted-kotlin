...
internal class EpisodeBulkRetrieveResponseTest {

    @Test
    fun create() {
        val episodeBulkRetrieveResponse =
            EpisodeBulkRetrieveResponse.builder()
                .addEpisode(
        ...
        assertThat(episodeBulkRetrieveResponse.episodes())
            .containsExactly(
                EpisodeObject.builder()
                    .id("5Xt5DXGzch68nYYamXrNxZ")
                    .audioPreviewUrl(
    ...
    fun roundtrip() {
        ...
        val roundtrippedEpisodeBulkRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(episodeBulkRetrieveResponse),
                jacksonTypeRef<EpisodeBulkRetrieveResponse>(),
            )

        assertThat(roundtrippedEpisodeBulkRetrieveResponse).isEqualTo(episodeBulkRetrieveResponse)
    }
}
